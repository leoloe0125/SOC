...
module AESL_axi_s_outStreamTop (
    input clk,
    input reset,
    input [24 - 1:0] TRAN_outStreamTop_TDATA,
    input [3 - 1:0] TRAN_outStreamTop_TKEEP,
    input [3 - 1:0] TRAN_outStreamTop_TSTRB,
    ...
    reg [24 - 1:0] outStreamTop_TDATA_write_data;
    reg outStreamTop_TDATA_read_en;
    wire [24 - 1:0] outStreamTop_TDATA_read_data;
    
    fifo #(64, 24) fifo_outStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [3 - 1:0] outStreamTop_TKEEP_write_data;
    reg outStreamTop_TKEEP_read_en;
    wire [3 - 1:0] outStreamTop_TKEEP_read_data;
    
    fifo #(64, 3) fifo_outStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [3 - 1:0] outStreamTop_TSTRB_write_data;
    reg outStreamTop_TSTRB_read_en;
    wire [3 - 1:0] outStreamTop_TSTRB_read_data;
    
    fifo #(64, 3) fifo_outStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
