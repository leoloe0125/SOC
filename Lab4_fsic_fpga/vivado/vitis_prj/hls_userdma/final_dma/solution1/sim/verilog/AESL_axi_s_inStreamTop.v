...
module AESL_axi_s_inStreamTop (
    input clk,
    input reset,
    output [24 - 1:0] TRAN_inStreamTop_TDATA,
    output [3 - 1:0] TRAN_inStreamTop_TKEEP,
    output [3 - 1:0] TRAN_inStreamTop_TSTRB,
    ...
    reg [24 - 1:0] inStreamTop_TDATA_write_data;
    reg inStreamTop_TDATA_read_en;
    wire [24 - 1:0] inStreamTop_TDATA_read_data;
    
    fifo #(64, 24) fifo_inStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [3 - 1:0] inStreamTop_TKEEP_write_data;
    reg inStreamTop_TKEEP_read_en;
    wire [3 - 1:0] inStreamTop_TKEEP_read_data;
    
    fifo #(64, 3) fifo_inStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [3 - 1:0] inStreamTop_TSTRB_write_data;
    reg inStreamTop_TSTRB_read_en;
    wire [3 - 1:0] inStreamTop_TSTRB_read_data;
    
    fifo #(64, 3) fifo_inStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
