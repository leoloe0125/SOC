...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inStreamTop_TDATA", 24, hls_in, 2, "axis", "in_data", 1),
	Port_Property("inStreamTop_TKEEP", 3, hls_in, 3, "axis", "in_data", 1),
	Port_Property("inStreamTop_TSTRB", 3, hls_in, 4, "axis", "in_data", 1),
	Port_Property("inStreamTop_TUSER", 7, hls_in, 5, "axis", "in_data", 1),
	Port_Property("inStreamTop_TLAST", 1, hls_in, 6, "axis", "in_data", 1),
	Port_Property("outStreamTop_TDATA", 24, hls_out, 19, "axis", "out_data", 1),
	Port_Property("outStreamTop_TKEEP", 3, hls_out, 20, "axis", "out_data", 1),
	Port_Property("outStreamTop_TSTRB", 3, hls_out, 21, "axis", "out_data", 1),
