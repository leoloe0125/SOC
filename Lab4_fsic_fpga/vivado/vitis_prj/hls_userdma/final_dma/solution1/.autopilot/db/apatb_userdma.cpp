...
{unsigned xlx_stream_outStreamTop_size = 0;
          ...
          std::vector<sc_bv<24> > outStreamTop_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > outStreamTop_V_data_V_pc_buffer;
          int i = 0;
...
outStreamTop_V_data_V_pc_buffer_Copy=outStreamTop_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > outStreamTop_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > outStreamTop_V_keep_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
outStreamTop_V_keep_V_pc_buffer_Copy=outStreamTop_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > outStreamTop_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > outStreamTop_V_strb_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
outStreamTop_V_strb_V_pc_buffer_Copy=outStreamTop_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > outStreamTop_V_user_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > outStreamTop_V_user_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
outStreamTop_V_user_V_pc_buffer_Copy=outStreamTop_V_user_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > outStreamTop_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > outStreamTop_V_last_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
tr.send<4>((char*)__xlx_apatb_param_s2mbuf, 64, 0);
}
#else
try {
...
for (int i = 0; i < __xlx_apatb_param_inStreamTop_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_inStreamTop_V_data_V_stream_buf.data()+i), 24);
aesl_fh.write(AUTOTB_TVIN_inStreamTop_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_inStreamTop_V_keep_V_stream_buf.data()+i), 3);
aesl_fh.write(AUTOTB_TVIN_inStreamTop_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_inStreamTop_V_strb_V_stream_buf.data()+i), 3);
...
for (int i = 0; i < __xlx_apatb_param_outStreamTop_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_outStreamTop_V_data_V_stream_buf.data()+__xlx_apatb_param_outStreamTop_stream_buf_size+i), 24);
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_outStreamTop_V_keep_V_stream_buf.data()+__xlx_apatb_param_outStreamTop_stream_buf_size+i), 3);
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_outStreamTop_V_strb_V_stream_buf.data()+__xlx_apatb_param_outStreamTop_stream_buf_size+i), 3);
