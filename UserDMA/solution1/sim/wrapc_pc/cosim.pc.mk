...
AUTOPILOT_ROOT := X:/Xilinx/Vitis_HLS/2021.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := X:/Xilinx/Vitis_HLS/2021.2/tps/win64/msys64/mingw64/bin
endif
...
$(ObjDir)/userdma_test.cpp_pre.cpp.tb.o : userdma_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling userdma_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/userdma.cpp_pre.cpp.tb.o : userdma.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling userdma.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
