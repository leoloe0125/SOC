...
input  [32:0] sub_i_i38;
input  [31:0] in_s2m_len;
output  [3:0] tmp_user_V_out;
output   tmp_user_V_out_ap_vld;
output  [0:0] icmp_ln1064_out;
output   icmp_ln1064_out_ap_vld;
...
wire   [0:0] icmp_ln1064_fu_189_p2;
reg   [0:0] icmp_ln1064_reg_292;
wire   [31:0] count_4_fu_214_p2;
reg   [31:0] count_4_reg_297;
wire   [0:0] icmp_ln71_fu_236_p2;
reg   [0:0] icmp_ln1072_reg_306;
wire   [31:0] select_ln1064_fu_200_p3;
reg   [31:0] count_fu_72;
wire    ap_loop_init;
reg   [31:0] empty_fu_76;
wire   [31:0] add_ln885_fu_220_p2;
reg    ap_block_pp0_stage0_01001;
wire  signed [31:0] sext_ln1064_fu_185_p0;
wire  signed [32:0] sext_ln1064_fu_185_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1072_reg_306 == 1'd0))) begin
        icmp_ln1064_out_ap_vld = 1'b1;
    end else begin
        icmp_ln1064_out_ap_vld = 1'b0;
    end
end
...
assign add_ln885_fu_220_p2 = (empty_fu_76 + 32'd1);
...
assign icmp_ln1064_fu_189_p2 = ((sext_ln1064_fu_185_p1 == sub_i_i38) ? 1'b1 : 1'b0);

assign icmp_ln1064_out = icmp_ln1064_reg_292;

assign icmp_ln1072_fu_252_p2 = ((add_ln885_fu_220_p2 < in_s2m_len) ? 1'b1 : 1'b0);
...
assign select_ln1064_fu_200_p3 = ((icmp_ln1064_fu_189_p2[0:0] == 1'b1) ? 32'd0 : add_ln67_fu_194_p2);

assign sext_ln1064_fu_185_p0 = width_count;

assign sext_ln1064_fu_185_p1 = sext_ln1064_fu_185_p0;
