...
# ==============================================================
set ::env(PATH) "$::env(PATH);X:/Xilinx/Vitis_HLS/2021.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);X:/Xilinx/Vitis_HLS/2021.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);X:/Xilinx/Vitis_HLS/2021.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);X:/Xilinx/Vitis_HLS/2021.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "userdma.autotvin.dat"
	set constFileTvOut       "userdma.autotvout.dat"
	set constFileHdlTvIn     "userdma.autohdltvin.dat"
	set constFileHdlTvOut    "userdma.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
