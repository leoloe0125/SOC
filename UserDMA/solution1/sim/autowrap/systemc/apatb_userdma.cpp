...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_s2mbuf, 64);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > gmem0_pc_buffer(64);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 64; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_s2mbuf)[j*4+0] = gmem0_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_s2mbuf)[j*4+1] = gmem0_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_s2mbuf)[j*4+2] = gmem0_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_s2mbuf)[j*4+3] = gmem0_pc_buffer[i].range(31, 24).to_int64();
}}}
        } // end transaction
      } // end file is good
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "s2m_buf_sts");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "s2m_err");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "m2s_buf_sts");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "outStreamTop");
...
tr.import<4>((char*)__xlx_apatb_param_s2mbuf, 64, 0);
  }
tr.reorder();
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_s2mbuf)[j];
...
tr.import<4>((char*)__xlx_apatb_param_m2sbuf, 64, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_gmem1, tr.p, tr.tbytes);
}

  tcl_file.set_num(64, &tcl_file.gmem1_depth);
#else
...
aesl_fh.write(AUTOTB_TVIN_gmem1, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_m2sbuf) {
    for (int j = 0  - 0, e = 64 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_m2sbuf)[j];
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_s2m_buf_sts);
aesl_fh.write(AUTOTB_TVIN_s2m_buf_sts, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_s2m_sts_clear);
aesl_fh.write(AUTOTB_TVIN_s2m_sts_clear, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_s2m_len);
aesl_fh.write(AUTOTB_TVIN_s2m_len, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_s2m_enb_clrsts);
aesl_fh.write(AUTOTB_TVIN_s2m_enb_clrsts, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_s2mbuf;
aesl_fh.write(AUTOTB_TVIN_s2mbuf, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_s2m_err);
aesl_fh.write(AUTOTB_TVIN_s2m_err, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_Img_width);
aesl_fh.write(AUTOTB_TVIN_Img_width, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_m2sbuf;
aesl_fh.write(AUTOTB_TVIN_m2sbuf, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_m2s_buf_sts);
aesl_fh.write(AUTOTB_TVIN_m2s_buf_sts, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_m2s_sts_clear);
aesl_fh.write(AUTOTB_TVIN_m2s_sts_clear, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_m2s_len);
aesl_fh.write(AUTOTB_TVIN_m2s_len, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_m2s_enb_clrsts);
aesl_fh.write(AUTOTB_TVIN_m2s_enb_clrsts, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
...
sc_bv<32> __xlx_tmp_0_lv = ((int*)&__xlx_apatb_param_inStreamTop_V_data_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_inStreamTop_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_inStreamTop_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_inStreamTop_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_inStreamTop_V_strb_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_inStreamTop_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<7> __xlx_tmp_3_lv = ((char*)&__xlx_apatb_param_inStreamTop_V_user_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_3_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_inStreamTop_V_user_V, __xlx_sprintf_buffer.data());
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_s2m_buf_sts);
aesl_fh.write(AUTOTB_TVOUT_s2m_buf_sts, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.s2m_buf_sts_depth);
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_s2m_err);
aesl_fh.write(AUTOTB_TVOUT_s2m_err, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.s2m_err_depth);
...
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_m2s_buf_sts);
aesl_fh.write(AUTOTB_TVOUT_m2s_buf_sts, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.m2s_buf_sts_depth);
...
for (int j = 0, e = __xlx_apatb_param_outStreamTop_stream_buf_final_size; j != e; ++j) {
sc_bv<32> __xlx_tmp_0_lv = ((int*)&__xlx_apatb_param_outStreamTop_V_data_V_stream_buf[__xlx_apatb_param_outStreamTop_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_outStreamTop_V_keep_V_stream_buf[__xlx_apatb_param_outStreamTop_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_outStreamTop_V_strb_V_stream_buf[__xlx_apatb_param_outStreamTop_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<7> __xlx_tmp_3_lv = ((char*)&__xlx_apatb_param_outStreamTop_V_user_V_stream_buf[__xlx_apatb_param_outStreamTop_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_3_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_user_V, __xlx_sprintf_buffer.data());
sc_bv<1> __xlx_tmp_4_lv = ((char*)&__xlx_apatb_param_outStreamTop_V_last_V_stream_buf[__xlx_apatb_param_outStreamTop_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_4_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_outStreamTop_V_last_V, __xlx_sprintf_buffer.data());
}
