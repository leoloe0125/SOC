; ModuleID = 'C:/Users/leolo/Project/SOC/UserDMA/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_userdma_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %inStreamTop, i1* %s2m_buf_sts, i1 %s2m_sts_clear, %"struct.ap_int<32>"* nocapture readonly %s2m_len, %"struct.ap_int<1>"* nocapture readonly %s2m_enb_clrsts, %"struct.ap_int<32>"* %s2mbuf, i1* %s2m_err, %"struct.ap_int<32>"* nocapture readonly %Img_width, %"struct.ap_int<32>"* %m2sbuf, i1* %m2s_buf_sts, i1 %m2s_sts_clear, i32 %m2s_len, %"struct.ap_int<1>"* nocapture readonly %m2s_enb_clrsts, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %outStreamTop) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %inStreamTop, i32* %inStreamTop_copy.data, i4* %inStreamTop_copy.keep, i4* %inStreamTop_copy.strb, i7* %inStreamTop_copy.user, i1* %inStreamTop_copy.last, i1* %s2m_buf_sts, i1* nonnull align 512 %s2m_buf_sts_copy, [64 x %"struct.ap_int<32>"]* %0, [64 x i32]* nonnull align 512 %s2mbuf_copy, i1* %s2m_err, i1* nonnull align 512 %s2m_err_copy, [64 x %"struct.ap_int<32>"]* %1, [64 x i32]* nonnull align 512 %m2sbuf_copy, i1* %m2s_buf_sts, i1* nonnull align 512 %m2s_buf_sts_copy, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %outStreamTop, i32* %outStreamTop_copy.data, i4* %outStreamTop_copy.keep, i4* %outStreamTop_copy.strb, i7* %outStreamTop_copy.user, i1* %outStreamTop_copy.last)
  ...
  call fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %inStreamTop, i32* %inStreamTop_copy.data, i4* %inStreamTop_copy.keep, i4* %inStreamTop_copy.strb, i7* %inStreamTop_copy.user, i1* %inStreamTop_copy.last, i1* %s2m_buf_sts, i1* nonnull align 512 %s2m_buf_sts_copy, [64 x %"struct.ap_int<32>"]* %0, [64 x i32]* nonnull align 512 %s2mbuf_copy, i1* %s2m_err, i1* nonnull align 512 %s2m_err_copy, [64 x %"struct.ap_int<32>"]* %1, [64 x i32]* nonnull align 512 %m2sbuf_copy, i1* %m2s_buf_sts, i1* nonnull align 512 %m2s_buf_sts_copy, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %outStreamTop, i32* %outStreamTop_copy.data, i4* %outStreamTop_copy.keep, i4* %outStreamTop_copy.strb, i7* %outStreamTop_copy.user, i1* %outStreamTop_copy.last)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* readonly, i1* noalias align 512, [64 x %"struct.ap_int<32>"]* readonly, [64 x i32]* noalias align 512, i1* readonly, i1* noalias align 512, [64 x %"struct.ap_int<32>"]* readonly, [64 x i32]* noalias align 512, i1* readonly, i1* noalias align 512, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.2" %_V_strb_V3, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.4" %_V_last_V5) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1*, i1* noalias readonly align 512, [64 x %"struct.ap_int<32>"]*, [64 x i32]* noalias readonly align 512, i1*, i1* noalias readonly align 512, [64 x %"struct.ap_int<32>"]*, [64 x i32]* noalias readonly align 512, i1*, i1* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.2" %_V_strb_V3, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.4" %_V_last_V5) unnamed_addr #3 {
entry:
...
entry:
  ...
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %22, i32* %0, i4* %1, i4* %2, i7* %3, i1* %4, i1* null, i1* %5, [64 x %"struct.ap_int<32>"]* %23, [64 x i32]* %26, i1* null, i1* %10, [64 x %"struct.ap_int<32>"]* %24, [64 x i32]* %27, i1* null, i1* %13, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %25, i32* %17, i4* %18, i4* %19, i7* %20, i1* %21)
  ...
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %22, i32* %0, i4* %1, i4* %2, i7* %3, i1* %4, i1* null, i1* %5, [64 x %"struct.ap_int<32>"]* %23, [64 x i32]* %26, i1* null, i1* %10, [64 x %"struct.ap_int<32>"]* %24, [64 x i32]* %27, i1* null, i1* %13, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %25, i32* %17, i4* %18, i4* %19, i7* %20, i1* %21)
  ret void
}
