...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "m2sbuf","offset": { "type": "dynamic","port_name": "m2sbuf","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "count_1", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ count_1 sc_in sc_lv 31 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "count_1", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "count_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	count_1 { ap_none {  { count_1 in_data 0 31 } } }
