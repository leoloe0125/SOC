...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_inbuf \
    op interface \
    ports { inbuf_din { O 33 vector } inbuf_full_n { I 1 bit } inbuf_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { incount47_din { O 32 vector } incount47_full_n { I 1 bit } incount47_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { s2m_len_c_din { O 32 vector } s2m_len_c_full_n { I 1 bit } s2m_len_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { s2m_enb_clrsts_c_din { O 1 vector } s2m_enb_clrsts_c_full_n { I 1 bit } s2m_enb_clrsts_c_write { O 1 bit } } \
} "
}
