...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outbuf \
    op interface \
    ports { outbuf_din { O 40 vector } outbuf_full_n { I 1 bit } outbuf_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outcount48_din { O 32 vector } outcount48_full_n { I 1 bit } outcount48_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { m2s_enb_clrsts_c_din { O 1 vector } m2s_enb_clrsts_c_full_n { I 1 bit } m2s_enb_clrsts_c_write { O 1 bit } } \
} "
}
