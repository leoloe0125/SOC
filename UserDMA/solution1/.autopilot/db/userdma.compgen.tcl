...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler userdma_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler userdma_gmem1_m_axi BINDTYPE interface TYPE interface_m_axi
}
