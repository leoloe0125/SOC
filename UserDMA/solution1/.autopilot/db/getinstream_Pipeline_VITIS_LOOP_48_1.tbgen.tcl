...
set C_modelArgMapList {[ 
	{ "Name" : "in_len_V_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sub_i_i38", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "icmp_ln1064_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sub_i_i38 sc_in sc_lv 33 signal 7 } 
	...
	{ icmp_ln1064_out sc_out sc_lv 1 signal 11 } 
	{ icmp_ln1064_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_i_i38", "direction": "in", "datatype": "sc_lv", "bitwidth":33, "type": "signal", "bundle":{"name": "sub_i_i38", "role": "default" }} , 
 	...
 	{ "name": "icmp_ln1064_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln1064_out", "role": "default" }} , 
 	{ "name": "icmp_ln1064_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "icmp_ln1064_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	sub_i_i38 { ap_none {  { sub_i_i38 in_data 0 33 } } }
	...
	icmp_ln1064_out { ap_vld {  { icmp_ln1064_out out_data 1 1 }  { icmp_ln1064_out_ap_vld out_vld 1 1 } } }
}
