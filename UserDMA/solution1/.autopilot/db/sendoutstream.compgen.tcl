...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outbuf \
    op interface \
    ports { outbuf_dout { I 40 vector } outbuf_empty_n { I 1 bit } outbuf_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outcount48_dout { I 32 vector } outcount48_empty_n { I 1 bit } outcount48_read { O 1 bit } } \
} "
}
