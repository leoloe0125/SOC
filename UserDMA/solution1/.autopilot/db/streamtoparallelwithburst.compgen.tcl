...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_inbuf \
    op interface \
    ports { inbuf_dout { I 33 vector } inbuf_empty_n { I 1 bit } inbuf_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { incount47_dout { I 32 vector } incount47_empty_n { I 1 bit } incount47_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_en_clrsts_dout { I 1 vector } in_en_clrsts_empty_n { I 1 bit } in_en_clrsts_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sts_clear_dout { I 1 vector } sts_clear_empty_n { I 1 bit } sts_clear_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_s2m_len_dout { I 32 vector } in_s2m_len_empty_n { I 1 bit } in_s2m_len_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_memory_dout { I 64 vector } out_memory_empty_n { I 1 bit } out_memory_read { O 1 bit } } \
} "
}
