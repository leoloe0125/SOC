...
`define TV_IN_inStreamTop_TDATA "./c.userdma.autotvin_inStreamTop_V_data_V.dat"
`define INGRESS_STATUS_inStreamTop_TDATA "./stream_ingress_status_inStreamTop_V_data_V.dat"
`define TV_IN_inStreamTop_TKEEP "./c.userdma.autotvin_inStreamTop_V_keep_V.dat"
`define INGRESS_STATUS_inStreamTop_TKEEP "./stream_ingress_status_inStreamTop_V_keep_V.dat"
`define TV_IN_inStreamTop_TSTRB "./c.userdma.autotvin_inStreamTop_V_strb_V.dat"
`define INGRESS_STATUS_inStreamTop_TSTRB "./stream_ingress_status_inStreamTop_V_strb_V.dat"
`define TV_IN_inStreamTop_TUSER "./c.userdma.autotvin_inStreamTop_V_user_V.dat"
`define INGRESS_STATUS_inStreamTop_TUSER "./stream_ingress_status_inStreamTop_V_user_V.dat"
`define TV_IN_inStreamTop_TLAST "./c.userdma.autotvin_inStreamTop_V_last_V.dat"
`define INGRESS_STATUS_inStreamTop_TLAST "./stream_ingress_status_inStreamTop_V_last_V.dat"
...
module AESL_axi_s_inStreamTop (
    ...
    output [7 - 1:0] TRAN_inStreamTop_TUSER,
    ...
    fifo #(64, 32) fifo_inStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(64, 4) fifo_inStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(64, 4) fifo_inStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [7 - 1:0] inStreamTop_TUSER_write_data;
    reg inStreamTop_TUSER_read_en;
    wire [7 - 1:0] inStreamTop_TUSER_read_data;
    
    fifo #(64, 7) fifo_inStreamTop_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(64, 1) fifo_inStreamTop_TLAST (
        .reset(1'b0),
        .write_clock(clk),
