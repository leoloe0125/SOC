...
//------------------------Parameter----------------------
`define TV_OUT_s2m_buf_sts "./rtl.userdma.autotvout_s2m_buf_sts.dat"
`define TV_IN_s2m_sts_clear "./c.userdma.autotvin_s2m_sts_clear.dat"
`define TV_IN_s2m_len "./c.userdma.autotvin_s2m_len.dat"
`define TV_IN_s2m_enb_clrsts "./c.userdma.autotvin_s2m_enb_clrsts.dat"
`define TV_IN_s2mbuf "./c.userdma.autotvin_s2mbuf.dat"
`define TV_OUT_s2m_err "./rtl.userdma.autotvout_s2m_err.dat"
`define TV_IN_Img_width "./c.userdma.autotvin_Img_width.dat"
`define TV_IN_m2sbuf "./c.userdma.autotvin_m2sbuf.dat"
`define TV_OUT_m2s_buf_sts "./rtl.userdma.autotvout_m2s_buf_sts.dat"
`define TV_IN_m2s_sts_clear "./c.userdma.autotvin_m2s_sts_clear.dat"
`define TV_IN_m2s_len "./c.userdma.autotvin_m2s_len.dat"
`define TV_IN_m2s_enb_clrsts "./c.userdma.autotvin_m2s_enb_clrsts.dat"
parameter ADDR_WIDTH = 8;
parameter DATA_WIDTH = 32;
parameter s2m_buf_sts_DEPTH = 1;
reg [31 : 0] s2m_buf_sts_OPERATE_DEPTH = 0;
parameter s2m_buf_sts_c_bitwidth = 1;
parameter s2m_sts_clear_DEPTH = 1;
reg [31 : 0] s2m_sts_clear_OPERATE_DEPTH = 0;
parameter s2m_sts_clear_c_bitwidth = 1;
parameter s2m_len_DEPTH = 1;
reg [31 : 0] s2m_len_OPERATE_DEPTH = 0;
parameter s2m_len_c_bitwidth = 32;
parameter s2m_enb_clrsts_DEPTH = 1;
reg [31 : 0] s2m_enb_clrsts_OPERATE_DEPTH = 0;
parameter s2m_enb_clrsts_c_bitwidth = 1;
...
parameter s2m_err_c_bitwidth = 1;
...
parameter m2s_sts_clear_DEPTH = 1;
reg [31 : 0] m2s_sts_clear_OPERATE_DEPTH = 0;
parameter m2s_sts_clear_c_bitwidth = 1;
parameter m2s_len_DEPTH = 1;
reg [31 : 0] m2s_len_OPERATE_DEPTH = 0;
parameter m2s_len_c_bitwidth = 32;
parameter m2s_enb_clrsts_DEPTH = 1;
reg [31 : 0] m2s_enb_clrsts_OPERATE_DEPTH = 0;
parameter m2s_enb_clrsts_c_bitwidth = 1;
parameter START_ADDR = 0;
parameter userdma_continue_addr = 0;
parameter userdma_auto_start_addr = 0;
parameter s2m_sts_clear_data_in_addr = 32;
parameter s2m_len_data_in_addr = 40;
parameter s2m_enb_clrsts_data_in_addr = 48;
parameter s2mbuf_data_in_addr = 56;
parameter Img_width_data_in_addr = 84;
parameter m2sbuf_data_in_addr = 92;
parameter m2s_sts_clear_data_in_addr = 120;
parameter m2s_len_data_in_addr = 128;
parameter m2s_enb_clrsts_data_in_addr = 136;
parameter s2m_buf_sts_data_out_addr = 16;
parameter s2m_buf_sts_valid_out_addr = 20;
parameter s2m_err_data_out_addr = 68;
parameter s2m_err_valid_out_addr = 72;
parameter m2s_buf_sts_data_out_addr = 104;
parameter m2s_buf_sts_valid_out_addr = 108;
...
reg [DATA_WIDTH - 1 : 0] mem_s2m_sts_clear [s2m_sts_clear_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_s2m_sts_clear [ (s2m_sts_clear_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * s2m_sts_clear_DEPTH -1 : 0] = '{default : 'hz};
reg s2m_sts_clear_write_data_finish;
reg [DATA_WIDTH - 1 : 0] mem_s2m_len [s2m_len_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_s2m_len [ (s2m_len_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * s2m_len_DEPTH -1 : 0] = '{default : 'hz};
reg s2m_len_write_data_finish;
reg [DATA_WIDTH - 1 : 0] mem_s2m_enb_clrsts [s2m_enb_clrsts_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_s2m_enb_clrsts [ (s2m_enb_clrsts_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * s2m_enb_clrsts_DEPTH -1 : 0] = '{default : 'hz};
reg s2m_enb_clrsts_write_data_finish;
...
reg [DATA_WIDTH - 1 : 0] mem_m2s_sts_clear [m2s_sts_clear_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_m2s_sts_clear [ (m2s_sts_clear_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * m2s_sts_clear_DEPTH -1 : 0] = '{default : 'hz};
reg m2s_sts_clear_write_data_finish;
reg [DATA_WIDTH - 1 : 0] mem_m2s_len [m2s_len_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_m2s_len [ (m2s_len_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * m2s_len_DEPTH -1 : 0] = '{default : 'hz};
reg m2s_len_write_data_finish;
reg [DATA_WIDTH - 1 : 0] mem_m2s_enb_clrsts [m2s_enb_clrsts_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_m2s_enb_clrsts [ (m2s_enb_clrsts_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * m2s_enb_clrsts_DEPTH -1 : 0] = '{default : 'hz};
reg m2s_enb_clrsts_write_data_finish;
...
//write s2m_sts_clear reg
reg [31 : 0] write_s2m_sts_clear_count = 0;
reg write_s2m_sts_clear_run_flag = 0;
reg write_one_s2m_sts_clear_data_done = 0;
//write s2m_len reg
reg [31 : 0] write_s2m_len_count = 0;
reg write_s2m_len_run_flag = 0;
reg write_one_s2m_len_data_done = 0;
//write s2m_enb_clrsts reg
reg [31 : 0] write_s2m_enb_clrsts_count = 0;
reg write_s2m_enb_clrsts_run_flag = 0;
reg write_one_s2m_enb_clrsts_data_done = 0;
//write s2mbuf reg
...
//write m2s_sts_clear reg
reg [31 : 0] write_m2s_sts_clear_count = 0;
reg write_m2s_sts_clear_run_flag = 0;
reg write_one_m2s_sts_clear_data_done = 0;
//write m2s_len reg
reg [31 : 0] write_m2s_len_count = 0;
reg write_m2s_len_run_flag = 0;
reg write_one_m2s_len_data_done = 0;
//write m2s_enb_clrsts reg
reg [31 : 0] write_m2s_enb_clrsts_count = 0;
reg write_m2s_enb_clrsts_run_flag = 0;
reg write_one_m2s_enb_clrsts_data_done = 0;
...
assign TRAN_control_read_data_finish = 1 & s2m_buf_sts_read_data_finish & s2m_err_read_data_finish & m2s_buf_sts_read_data_finish;
assign TRAN_control_write_data_finish = 1 & s2m_sts_clear_write_data_finish & s2m_len_write_data_finish & s2m_enb_clrsts_write_data_finish & s2mbuf_write_data_finish & Img_width_write_data_finish & m2sbuf_write_data_finish & m2s_sts_clear_write_data_finish & m2s_len_write_data_finish & m2s_enb_clrsts_write_data_finish;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        s2m_sts_clear_write_data_finish <= 0;
        write_s2m_sts_clear_run_flag <= 0; 
        write_s2m_sts_clear_count = 0;
        count_operate_depth_by_bitwidth_and_depth (s2m_sts_clear_c_bitwidth, s2m_sts_clear_DEPTH, s2m_sts_clear_OPERATE_DEPTH);
    end
    else begin
        ...
        if (AESL_ready_reg === 1) begin
            write_s2m_sts_clear_run_flag <= 1; 
            write_s2m_sts_clear_count = 0;
        end
        if (write_one_s2m_sts_clear_data_done === 1) begin
            write_s2m_sts_clear_count = write_s2m_sts_clear_count + 1;
            if (write_s2m_sts_clear_count == s2m_sts_clear_OPERATE_DEPTH) begin
                write_s2m_sts_clear_run_flag <= 0; 
                s2m_sts_clear_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_s2m_sts_clear
    integer write_s2m_sts_clear_resp;
    integer process_num ;
    integer get_ack;
    ...
    integer i;
    integer j;
    reg [31 : 0] s2m_sts_clear_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = s2m_sts_clear_c_bitwidth;
    process_num = 1;
    ...
    while (1) begin
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_s2m_sts_clear_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write s2m_sts_clear data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (s2m_sts_clear_c_bitwidth < 32) begin
                        s2m_sts_clear_data_tmp_reg = mem_s2m_sts_clear[write_s2m_sts_clear_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < s2m_sts_clear_c_bitwidth) begin
                                s2m_sts_clear_data_tmp_reg[j] = mem_s2m_sts_clear[write_s2m_sts_clear_count][i*32 + j];
                            end
                            else begin
                                s2m_sts_clear_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    if(image_mem_s2m_sts_clear[write_s2m_sts_clear_count * four_byte_num  + i]!==s2m_sts_clear_data_tmp_reg) begin
                    write (s2m_sts_clear_data_in_addr + write_s2m_sts_clear_count * four_byte_num * 4 + i * 4, s2m_sts_clear_data_tmp_reg, write_s2m_sts_clear_resp);
                    image_mem_s2m_sts_clear[write_s2m_sts_clear_count * four_byte_num + i]=s2m_sts_clear_data_tmp_reg;
                    end
                end
                process_busy = 0;
                write_one_s2m_sts_clear_data_done <= 1;
                @(posedge clk);
                write_one_s2m_sts_clear_data_done <= 0;
            end   
            process_1_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        s2m_len_write_data_finish <= 0;
        write_s2m_len_run_flag <= 0; 
        write_s2m_len_count = 0;
        count_operate_depth_by_bitwidth_and_depth (s2m_len_c_bitwidth, s2m_len_DEPTH, s2m_len_OPERATE_DEPTH);
    end
    else begin
        if (TRAN_control_start_in === 1) begin
            s2m_len_write_data_finish <= 0;
        ...
        if (AESL_ready_reg === 1) begin
            write_s2m_len_run_flag <= 1; 
            write_s2m_len_count = 0;
        end
        if (write_one_s2m_len_data_done === 1) begin
            write_s2m_len_count = write_s2m_len_count + 1;
            if (write_s2m_len_count == s2m_len_OPERATE_DEPTH) begin
                write_s2m_len_run_flag <= 0; 
                s2m_len_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_s2m_len
    integer write_s2m_len_resp;
    integer process_num ;
    integer get_ack;
    integer four_byte_num;
    integer c_bitwidth;
    integer i;
    integer j;
    reg [31 : 0] s2m_len_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = s2m_len_c_bitwidth;
    process_num = 2;
    count_c_data_four_byte_num_by_bitwidth (c_bitwidth , four_byte_num) ;
    while (1) begin
        process_2_finish <= 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_s2m_len_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write s2m_len data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (s2m_len_c_bitwidth < 32) begin
                        s2m_len_data_tmp_reg = mem_s2m_len[write_s2m_len_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < s2m_len_c_bitwidth) begin
                                s2m_len_data_tmp_reg[j] = mem_s2m_len[write_s2m_len_count][i*32 + j];
                            end
                            else begin
                                s2m_len_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    if(image_mem_s2m_len[write_s2m_len_count * four_byte_num  + i]!==s2m_len_data_tmp_reg) begin
                    write (s2m_len_data_in_addr + write_s2m_len_count * four_byte_num * 4 + i * 4, s2m_len_data_tmp_reg, write_s2m_len_resp);
                    image_mem_s2m_len[write_s2m_len_count * four_byte_num + i]=s2m_len_data_tmp_reg;
                    end
                end
                process_busy = 0;
                write_one_s2m_len_data_done <= 1;
                @(posedge clk);
                write_one_s2m_len_data_done <= 0;
            end   
            process_2_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        s2m_enb_clrsts_write_data_finish <= 0;
        write_s2m_enb_clrsts_run_flag <= 0; 
        write_s2m_enb_clrsts_count = 0;
        count_operate_depth_by_bitwidth_and_depth (s2m_enb_clrsts_c_bitwidth, s2m_enb_clrsts_DEPTH, s2m_enb_clrsts_OPERATE_DEPTH);
    end
    else begin
        if (TRAN_control_start_in === 1) begin
            s2m_enb_clrsts_write_data_finish <= 0;
        ...
        if (AESL_ready_reg === 1) begin
            write_s2m_enb_clrsts_run_flag <= 1; 
            write_s2m_enb_clrsts_count = 0;
        end
        if (write_one_s2m_enb_clrsts_data_done === 1) begin
            write_s2m_enb_clrsts_count = write_s2m_enb_clrsts_count + 1;
            if (write_s2m_enb_clrsts_count == s2m_enb_clrsts_OPERATE_DEPTH) begin
                write_s2m_enb_clrsts_run_flag <= 0; 
                s2m_enb_clrsts_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_s2m_enb_clrsts
    integer write_s2m_enb_clrsts_resp;
    integer process_num ;
    integer get_ack;
    integer four_byte_num;
    integer c_bitwidth;
    integer i;
    integer j;
    reg [31 : 0] s2m_enb_clrsts_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = s2m_enb_clrsts_c_bitwidth;
    process_num = 3;
    count_c_data_four_byte_num_by_bitwidth (c_bitwidth , four_byte_num) ;
    while (1) begin
        process_3_finish <= 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_s2m_enb_clrsts_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write s2m_enb_clrsts data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (s2m_enb_clrsts_c_bitwidth < 32) begin
                        s2m_enb_clrsts_data_tmp_reg = mem_s2m_enb_clrsts[write_s2m_enb_clrsts_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < s2m_enb_clrsts_c_bitwidth) begin
                                s2m_enb_clrsts_data_tmp_reg[j] = mem_s2m_enb_clrsts[write_s2m_enb_clrsts_count][i*32 + j];
                            end
                            else begin
                                s2m_enb_clrsts_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    if(image_mem_s2m_enb_clrsts[write_s2m_enb_clrsts_count * four_byte_num  + i]!==s2m_enb_clrsts_data_tmp_reg) begin
                    write (s2m_enb_clrsts_data_in_addr + write_s2m_enb_clrsts_count * four_byte_num * 4 + i * 4, s2m_enb_clrsts_data_tmp_reg, write_s2m_enb_clrsts_resp);
                    image_mem_s2m_enb_clrsts[write_s2m_enb_clrsts_count * four_byte_num + i]=s2m_enb_clrsts_data_tmp_reg;
                    end
                end
                process_busy = 0;
                write_one_s2m_enb_clrsts_data_done <= 1;
                @(posedge clk);
                write_one_s2m_enb_clrsts_data_done <= 0;
            end   
            process_3_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (write_one_Img_width_data_done === 1) begin
            ...
            if (write_Img_width_count == Img_width_OPERATE_DEPTH) begin
                write_Img_width_run_flag <= 0; 
            ...
            if (write_Img_width_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (Img_width_c_bitwidth < 32) begin
                        Img_width_data_tmp_reg = mem_Img_width[write_Img_width_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < Img_width_c_bitwidth) begin
                                Img_width_data_tmp_reg[j] = mem_Img_width[write_Img_width_count][i*32 + j];
                            end
                            else begin
                    ...
                    if(image_mem_Img_width[write_Img_width_count * four_byte_num  + i]!==Img_width_data_tmp_reg) begin
                    write (Img_width_data_in_addr + write_Img_width_count * four_byte_num * 4 + i * 4, Img_width_data_tmp_reg, write_Img_width_resp);
                    image_mem_Img_width[write_Img_width_count * four_byte_num + i]=Img_width_data_tmp_reg;
                    end
                end
                process_busy = 0;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        m2s_sts_clear_write_data_finish <= 0;
        write_m2s_sts_clear_run_flag <= 0; 
        write_m2s_sts_clear_count = 0;
        count_operate_depth_by_bitwidth_and_depth (m2s_sts_clear_c_bitwidth, m2s_sts_clear_DEPTH, m2s_sts_clear_OPERATE_DEPTH);
    end
    else begin
        if (TRAN_control_start_in === 1) begin
            m2s_sts_clear_write_data_finish <= 0;
        ...
        if (AESL_ready_reg === 1) begin
            write_m2s_sts_clear_run_flag <= 1; 
            write_m2s_sts_clear_count = 0;
        end
        if (write_one_m2s_sts_clear_data_done === 1) begin
            write_m2s_sts_clear_count = write_m2s_sts_clear_count + 1;
            if (write_m2s_sts_clear_count == m2s_sts_clear_OPERATE_DEPTH) begin
                write_m2s_sts_clear_run_flag <= 0; 
                m2s_sts_clear_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_m2s_sts_clear
    integer write_m2s_sts_clear_resp;
    integer process_num ;
    integer get_ack;
    integer four_byte_num;
    integer c_bitwidth;
    integer i;
    integer j;
    reg [31 : 0] m2s_sts_clear_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = m2s_sts_clear_c_bitwidth;
    process_num = 7;
    count_c_data_four_byte_num_by_bitwidth (c_bitwidth , four_byte_num) ;
    while (1) begin
        process_7_finish <= 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_m2s_sts_clear_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write m2s_sts_clear data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (m2s_sts_clear_c_bitwidth < 32) begin
                        m2s_sts_clear_data_tmp_reg = mem_m2s_sts_clear[write_m2s_sts_clear_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < m2s_sts_clear_c_bitwidth) begin
                                m2s_sts_clear_data_tmp_reg[j] = mem_m2s_sts_clear[write_m2s_sts_clear_count][i*32 + j];
                            end
                            else begin
                                m2s_sts_clear_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    if(image_mem_m2s_sts_clear[write_m2s_sts_clear_count * four_byte_num  + i]!==m2s_sts_clear_data_tmp_reg) begin
                    write (m2s_sts_clear_data_in_addr + write_m2s_sts_clear_count * four_byte_num * 4 + i * 4, m2s_sts_clear_data_tmp_reg, write_m2s_sts_clear_resp);
                    image_mem_m2s_sts_clear[write_m2s_sts_clear_count * four_byte_num + i]=m2s_sts_clear_data_tmp_reg;
                    end
                end
                process_busy = 0;
                write_one_m2s_sts_clear_data_done <= 1;
                @(posedge clk);
                write_one_m2s_sts_clear_data_done <= 0;
            end   
            process_7_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        m2s_len_write_data_finish <= 0;
        write_m2s_len_run_flag <= 0; 
        write_m2s_len_count = 0;
        count_operate_depth_by_bitwidth_and_depth (m2s_len_c_bitwidth, m2s_len_DEPTH, m2s_len_OPERATE_DEPTH);
    end
    else begin
        if (TRAN_control_start_in === 1) begin
            m2s_len_write_data_finish <= 0;
        ...
        if (AESL_ready_reg === 1) begin
            write_m2s_len_run_flag <= 1; 
            write_m2s_len_count = 0;
        end
        if (write_one_m2s_len_data_done === 1) begin
            write_m2s_len_count = write_m2s_len_count + 1;
            if (write_m2s_len_count == m2s_len_OPERATE_DEPTH) begin
                write_m2s_len_run_flag <= 0; 
                m2s_len_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_m2s_len
    integer write_m2s_len_resp;
    integer process_num ;
    integer get_ack;
    integer four_byte_num;
    integer c_bitwidth;
    integer i;
    integer j;
    reg [31 : 0] m2s_len_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = m2s_len_c_bitwidth;
    process_num = 8;
    count_c_data_four_byte_num_by_bitwidth (c_bitwidth , four_byte_num) ;
    while (1) begin
        process_8_finish <= 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_m2s_len_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write m2s_len data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (m2s_len_c_bitwidth < 32) begin
                        m2s_len_data_tmp_reg = mem_m2s_len[write_m2s_len_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < m2s_len_c_bitwidth) begin
                                m2s_len_data_tmp_reg[j] = mem_m2s_len[write_m2s_len_count][i*32 + j];
                            end
                            else begin
                                m2s_len_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    if(image_mem_m2s_len[write_m2s_len_count * four_byte_num  + i]!==m2s_len_data_tmp_reg) begin
                    write (m2s_len_data_in_addr + write_m2s_len_count * four_byte_num * 4 + i * 4, m2s_len_data_tmp_reg, write_m2s_len_resp);
                    image_mem_m2s_len[write_m2s_len_count * four_byte_num + i]=m2s_len_data_tmp_reg;
                    end
                end
                process_busy = 0;
                write_one_m2s_len_data_done <= 1;
                @(posedge clk);
                write_one_m2s_len_data_done <= 0;
            end   
            process_8_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        m2s_enb_clrsts_write_data_finish <= 0;
        write_m2s_enb_clrsts_run_flag <= 0; 
        write_m2s_enb_clrsts_count = 0;
        count_operate_depth_by_bitwidth_and_depth (m2s_enb_clrsts_c_bitwidth, m2s_enb_clrsts_DEPTH, m2s_enb_clrsts_OPERATE_DEPTH);
    end
    else begin
        if (TRAN_control_start_in === 1) begin
            m2s_enb_clrsts_write_data_finish <= 0;
        ...
        if (AESL_ready_reg === 1) begin
            write_m2s_enb_clrsts_run_flag <= 1; 
            write_m2s_enb_clrsts_count = 0;
        end
        if (write_one_m2s_enb_clrsts_data_done === 1) begin
            write_m2s_enb_clrsts_count = write_m2s_enb_clrsts_count + 1;
            if (write_m2s_enb_clrsts_count == m2s_enb_clrsts_OPERATE_DEPTH) begin
                write_m2s_enb_clrsts_run_flag <= 0; 
                m2s_enb_clrsts_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_m2s_enb_clrsts
    integer write_m2s_enb_clrsts_resp;
    integer process_num ;
    integer get_ack;
    integer four_byte_num;
    integer c_bitwidth;
    integer i;
    integer j;
    reg [31 : 0] m2s_enb_clrsts_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = m2s_enb_clrsts_c_bitwidth;
    process_num = 9;
    count_c_data_four_byte_num_by_bitwidth (c_bitwidth , four_byte_num) ;
    while (1) begin
        process_9_finish <= 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_m2s_enb_clrsts_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write m2s_enb_clrsts data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (m2s_enb_clrsts_c_bitwidth < 32) begin
                        m2s_enb_clrsts_data_tmp_reg = mem_m2s_enb_clrsts[write_m2s_enb_clrsts_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < m2s_enb_clrsts_c_bitwidth) begin
                                m2s_enb_clrsts_data_tmp_reg[j] = mem_m2s_enb_clrsts[write_m2s_enb_clrsts_count][i*32 + j];
                            end
                            else begin
                                m2s_enb_clrsts_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    if(image_mem_m2s_enb_clrsts[write_m2s_enb_clrsts_count * four_byte_num  + i]!==m2s_enb_clrsts_data_tmp_reg) begin
                    write (m2s_enb_clrsts_data_in_addr + write_m2s_enb_clrsts_count * four_byte_num * 4 + i * 4, m2s_enb_clrsts_data_tmp_reg, write_m2s_enb_clrsts_resp);
                    image_mem_m2s_enb_clrsts[write_m2s_enb_clrsts_count * four_byte_num + i]=m2s_enb_clrsts_data_tmp_reg;
                    end
                end
                process_busy = 0;
                write_one_m2s_enb_clrsts_data_done <= 1;
                @(posedge clk);
                write_one_m2s_enb_clrsts_data_done <= 0;
            end   
            process_9_finish <= 1;
        end
        @(posedge clk);
...
// Read data from file 
initial begin : read_s2m_sts_clear_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [s2m_sts_clear_c_bitwidth - 1 : 0] token_tmp; 
  ...
  count_seperate_factor_by_bitwidth (s2m_sts_clear_c_bitwidth , factor);
  fp = $fopen(`TV_IN_s2m_sts_clear ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_s2m_sts_clear); 
      $finish; 
  end 
  read_token(fp, token); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < s2m_sts_clear_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  mem_s2m_sts_clear [i/factor] = tmp_cache_mem;
                  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
...
task write_binary_s2m_sts_clear;
    input integer fp;
    input reg[64-1:0] in;
    input integer in_bw;
    reg [63:0] tmp_long;
...
// Read data from file 
initial begin : read_s2m_len_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [s2m_len_c_bitwidth - 1 : 0] token_tmp; 
  reg [DATA_WIDTH - 1 : 0] tmp_cache_mem; 
  reg [ 8*5 : 1] str;
    reg [63:0] trans_depth;
  integer transaction_idx; 
  ...
  transaction_idx = 0; 
  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
  count_seperate_factor_by_bitwidth (s2m_len_c_bitwidth , factor);
  fp = $fopen(`TV_IN_s2m_len ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_s2m_len); 
      $finish; 
  end 
  read_token(fp, token); 
  if (token != "[[[runtime]]]") begin             // Illegal format 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < s2m_len_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ret = $sscanf(token, "0x%x", token_tmp); 
          if (factor == 4) begin
              if (i%factor == 0) begin
              ...
              if (i%factor == 3) begin
                  tmp_cache_mem [31 : 24] = token_tmp;
                  mem_s2m_len [i/factor] = tmp_cache_mem;
                  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
...
// Read data from file 
initial begin : read_s2m_enb_clrsts_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [s2m_enb_clrsts_c_bitwidth - 1 : 0] token_tmp; 
  reg [DATA_WIDTH - 1 : 0] tmp_cache_mem; 
  reg [ 8*5 : 1] str;
    reg [63:0] trans_depth;
  integer transaction_idx; 
  ...
  transaction_idx = 0; 
  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
  count_seperate_factor_by_bitwidth (s2m_enb_clrsts_c_bitwidth , factor);
  fp = $fopen(`TV_IN_s2m_enb_clrsts ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_s2m_enb_clrsts); 
      $finish; 
  end 
  read_token(fp, token); 
  if (token != "[[[runtime]]]") begin             // Illegal format 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < s2m_enb_clrsts_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ret = $sscanf(token, "0x%x", token_tmp); 
          if (factor == 4) begin
              if (i%factor == 0) begin
              ...
              if (i%factor == 3) begin
                  tmp_cache_mem [31 : 24] = token_tmp;
                  mem_s2m_enb_clrsts [i/factor] = tmp_cache_mem;
                  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
          ...
          if (factor == 1) begin
              mem_s2m_enb_clrsts [i] = token_tmp;
          end
      end 
      if (factor == 4) begin
          if (i%factor != 0) begin
...
task write_binary_s2m_enb_clrsts;
    input integer fp;
    input reg[64-1:0] in;
    input integer in_bw;
    reg [63:0] tmp_long;
...
// Read data from file 
initial begin : read_m2s_sts_clear_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [m2s_sts_clear_c_bitwidth - 1 : 0] token_tmp; 
  reg [DATA_WIDTH - 1 : 0] tmp_cache_mem; 
  reg [ 8*5 : 1] str;
    reg [63:0] trans_depth;
  integer transaction_idx; 
  ...
  transaction_idx = 0; 
  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
  count_seperate_factor_by_bitwidth (m2s_sts_clear_c_bitwidth , factor);
  fp = $fopen(`TV_IN_m2s_sts_clear ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_m2s_sts_clear); 
      $finish; 
  end 
  read_token(fp, token); 
  if (token != "[[[runtime]]]") begin             // Illegal format 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < m2s_sts_clear_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ret = $sscanf(token, "0x%x", token_tmp); 
          if (factor == 4) begin
              if (i%factor == 0) begin
              ...
              if (i%factor == 3) begin
                  tmp_cache_mem [31 : 24] = token_tmp;
                  mem_m2s_sts_clear [i/factor] = tmp_cache_mem;
                  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
...
task write_binary_m2s_sts_clear;
    input integer fp;
    input reg[64-1:0] in;
    input integer in_bw;
    reg [63:0] tmp_long;
...
// Read data from file 
initial begin : read_m2s_len_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [m2s_len_c_bitwidth - 1 : 0] token_tmp; 
  reg [DATA_WIDTH - 1 : 0] tmp_cache_mem; 
  reg [ 8*5 : 1] str;
    reg [63:0] trans_depth;
  integer transaction_idx; 
  ...
  transaction_idx = 0; 
  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
  count_seperate_factor_by_bitwidth (m2s_len_c_bitwidth , factor);
  fp = $fopen(`TV_IN_m2s_len ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_m2s_len); 
      $finish; 
  end 
  read_token(fp, token); 
  if (token != "[[[runtime]]]") begin             // Illegal format 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < m2s_len_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ret = $sscanf(token, "0x%x", token_tmp); 
          if (factor == 4) begin
              if (i%factor == 0) begin
              ...
              if (i%factor == 3) begin
                  tmp_cache_mem [31 : 24] = token_tmp;
                  mem_m2s_len [i/factor] = tmp_cache_mem;
                  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
...
// Read data from file 
initial begin : read_m2s_enb_clrsts_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [m2s_enb_clrsts_c_bitwidth - 1 : 0] token_tmp; 
  reg [DATA_WIDTH - 1 : 0] tmp_cache_mem; 
  reg [ 8*5 : 1] str;
    reg [63:0] trans_depth;
  integer transaction_idx; 
  ...
  transaction_idx = 0; 
  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
  count_seperate_factor_by_bitwidth (m2s_enb_clrsts_c_bitwidth , factor);
  fp = $fopen(`TV_IN_m2s_enb_clrsts ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_m2s_enb_clrsts); 
      $finish; 
  end 
  read_token(fp, token); 
  if (token != "[[[runtime]]]") begin             // Illegal format 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < m2s_enb_clrsts_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ret = $sscanf(token, "0x%x", token_tmp); 
          if (factor == 4) begin
              if (i%factor == 0) begin
              ...
              if (i%factor == 3) begin
                  tmp_cache_mem [31 : 24] = token_tmp;
                  mem_m2s_enb_clrsts [i/factor] = tmp_cache_mem;
                  tmp_cache_mem [DATA_WIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
          ...
          if (factor == 1) begin
              mem_m2s_enb_clrsts [i] = token_tmp;
          end
      end 
      if (factor == 4) begin
          if (i%factor != 0) begin
...
task write_binary_m2s_enb_clrsts;
    input integer fp;
    input reg[64-1:0] in;
    input integer in_bw;
    reg [63:0] tmp_long;
