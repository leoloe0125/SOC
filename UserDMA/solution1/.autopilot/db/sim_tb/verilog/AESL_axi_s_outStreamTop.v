...
`define TV_OUT_outStreamTop_TDATA "./impl_rtl.userdma.autotvout_outStreamTop_V_data_V.dat"
`define EGRESS_STATUS_outStreamTop_TDATA "./stream_egress_status_outStreamTop_V_data_V.dat"
`define TV_OUT_outStreamTop_TKEEP "./impl_rtl.userdma.autotvout_outStreamTop_V_keep_V.dat"
`define EGRESS_STATUS_outStreamTop_TKEEP "./stream_egress_status_outStreamTop_V_keep_V.dat"
`define TV_OUT_outStreamTop_TSTRB "./impl_rtl.userdma.autotvout_outStreamTop_V_strb_V.dat"
`define EGRESS_STATUS_outStreamTop_TSTRB "./stream_egress_status_outStreamTop_V_strb_V.dat"
`define TV_OUT_outStreamTop_TUSER "./impl_rtl.userdma.autotvout_outStreamTop_V_user_V.dat"
`define EGRESS_STATUS_outStreamTop_TUSER "./stream_egress_status_outStreamTop_V_user_V.dat"
`define TV_OUT_outStreamTop_TLAST "./impl_rtl.userdma.autotvout_outStreamTop_V_last_V.dat"
`define EGRESS_STATUS_outStreamTop_TLAST "./stream_egress_status_outStreamTop_V_last_V.dat"
...
module AESL_axi_s_outStreamTop (
    ...
    input [7 - 1:0] TRAN_outStreamTop_TUSER,
    ...
    fifo #(64, 32) fifo_outStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(64, 4) fifo_outStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(64, 4) fifo_outStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [7 - 1:0] outStreamTop_TUSER_write_data;
    reg outStreamTop_TUSER_read_en;
    wire [7 - 1:0] outStreamTop_TUSER_read_data;
    
    fifo #(64, 7) fifo_outStreamTop_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(64, 1) fifo_outStreamTop_TLAST (
        .reset(1'b0),
        .write_clock(clk),
