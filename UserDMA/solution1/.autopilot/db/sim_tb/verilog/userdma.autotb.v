...
`define AUTOTB_TVIN_gmem1  "./c.userdma.autotvin_gmem1.dat"
`define AUTOTB_TVIN_inStreamTop_V_data_V  "./c.userdma.autotvin_inStreamTop_V_data_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_keep_V  "./c.userdma.autotvin_inStreamTop_V_keep_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_strb_V  "./c.userdma.autotvin_inStreamTop_V_strb_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_user_V  "./c.userdma.autotvin_inStreamTop_V_user_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_last_V  "./c.userdma.autotvin_inStreamTop_V_last_V.dat"
`define AUTOTB_TVIN_s2m_sts_clear  "./c.userdma.autotvin_s2m_sts_clear.dat"
`define AUTOTB_TVIN_s2m_len  "./c.userdma.autotvin_s2m_len.dat"
`define AUTOTB_TVIN_s2m_enb_clrsts  "./c.userdma.autotvin_s2m_enb_clrsts.dat"
`define AUTOTB_TVIN_s2mbuf  "./c.userdma.autotvin_s2mbuf.dat"
`define AUTOTB_TVIN_Img_width  "./c.userdma.autotvin_Img_width.dat"
`define AUTOTB_TVIN_m2sbuf  "./c.userdma.autotvin_m2sbuf.dat"
`define AUTOTB_TVIN_m2s_sts_clear  "./c.userdma.autotvin_m2s_sts_clear.dat"
`define AUTOTB_TVIN_m2s_len  "./c.userdma.autotvin_m2s_len.dat"
`define AUTOTB_TVIN_m2s_enb_clrsts  "./c.userdma.autotvin_m2s_enb_clrsts.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.userdma.autotvin_gmem1.dat"
`define AUTOTB_TVIN_inStreamTop_V_data_V_out_wrapc  "./rtl.userdma.autotvin_inStreamTop_V_data_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_keep_V_out_wrapc  "./rtl.userdma.autotvin_inStreamTop_V_keep_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_strb_V_out_wrapc  "./rtl.userdma.autotvin_inStreamTop_V_strb_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_user_V_out_wrapc  "./rtl.userdma.autotvin_inStreamTop_V_user_V.dat"
`define AUTOTB_TVIN_inStreamTop_V_last_V_out_wrapc  "./rtl.userdma.autotvin_inStreamTop_V_last_V.dat"
`define AUTOTB_TVIN_s2m_sts_clear_out_wrapc  "./rtl.userdma.autotvin_s2m_sts_clear.dat"
`define AUTOTB_TVIN_s2m_len_out_wrapc  "./rtl.userdma.autotvin_s2m_len.dat"
`define AUTOTB_TVIN_s2m_enb_clrsts_out_wrapc  "./rtl.userdma.autotvin_s2m_enb_clrsts.dat"
`define AUTOTB_TVIN_s2mbuf_out_wrapc  "./rtl.userdma.autotvin_s2mbuf.dat"
`define AUTOTB_TVIN_Img_width_out_wrapc  "./rtl.userdma.autotvin_Img_width.dat"
`define AUTOTB_TVIN_m2sbuf_out_wrapc  "./rtl.userdma.autotvin_m2sbuf.dat"
`define AUTOTB_TVIN_m2s_sts_clear_out_wrapc  "./rtl.userdma.autotvin_m2s_sts_clear.dat"
`define AUTOTB_TVIN_m2s_len_out_wrapc  "./rtl.userdma.autotvin_m2s_len.dat"
`define AUTOTB_TVIN_m2s_enb_clrsts_out_wrapc  "./rtl.userdma.autotvin_m2s_enb_clrsts.dat"
`define AUTOTB_TVOUT_gmem0  "./c.userdma.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_s2m_buf_sts  "./c.userdma.autotvout_s2m_buf_sts.dat"
`define AUTOTB_TVOUT_s2m_err  "./c.userdma.autotvout_s2m_err.dat"
`define AUTOTB_TVOUT_m2s_buf_sts  "./c.userdma.autotvout_m2s_buf_sts.dat"
`define AUTOTB_TVOUT_outStreamTop_V_data_V  "./c.userdma.autotvout_outStreamTop_V_data_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_keep_V  "./c.userdma.autotvout_outStreamTop_V_keep_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_strb_V  "./c.userdma.autotvout_outStreamTop_V_strb_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_user_V  "./c.userdma.autotvout_outStreamTop_V_user_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_last_V  "./c.userdma.autotvout_outStreamTop_V_last_V.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "./impl_rtl.userdma.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_s2m_buf_sts_out_wrapc  "./impl_rtl.userdma.autotvout_s2m_buf_sts.dat"
`define AUTOTB_TVOUT_s2m_err_out_wrapc  "./impl_rtl.userdma.autotvout_s2m_err.dat"
`define AUTOTB_TVOUT_m2s_buf_sts_out_wrapc  "./impl_rtl.userdma.autotvout_m2s_buf_sts.dat"
`define AUTOTB_TVOUT_outStreamTop_V_data_V_out_wrapc  "./impl_rtl.userdma.autotvout_outStreamTop_V_data_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_keep_V_out_wrapc  "./impl_rtl.userdma.autotvout_outStreamTop_V_keep_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_strb_V_out_wrapc  "./impl_rtl.userdma.autotvout_outStreamTop_V_strb_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_user_V_out_wrapc  "./impl_rtl.userdma.autotvout_outStreamTop_V_user_V.dat"
`define AUTOTB_TVOUT_outStreamTop_V_last_V_out_wrapc  "./impl_rtl.userdma.autotvout_outStreamTop_V_last_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.userdma.autotvout_outStreamTop_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.userdma.autotvout_outStreamTop_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.userdma.autotvout_outStreamTop_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.userdma.autotvout_outStreamTop_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.userdma.autotvout_outStreamTop_V_data_V.dat with impl_rtl.userdma.autotvout_outStreamTop_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.userdma.autotvout_outStreamTop_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.userdma.autotvout_outStreamTop_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.userdma.autotvout_outStreamTop_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.userdma.autotvout_outStreamTop_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.userdma.autotvout_outStreamTop_V_keep_V.dat with impl_rtl.userdma.autotvout_outStreamTop_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.userdma.autotvout_outStreamTop_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.userdma.autotvout_outStreamTop_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.userdma.autotvout_outStreamTop_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.userdma.autotvout_outStreamTop_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.userdma.autotvout_outStreamTop_V_strb_V.dat with impl_rtl.userdma.autotvout_outStreamTop_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.userdma.autotvout_outStreamTop_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.userdma.autotvout_outStreamTop_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.userdma.autotvout_outStreamTop_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.userdma.autotvout_outStreamTop_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.userdma.autotvout_outStreamTop_V_user_V.dat with impl_rtl.userdma.autotvout_outStreamTop_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.userdma.autotvout_outStreamTop_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.userdma.autotvout_outStreamTop_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.userdma.autotvout_outStreamTop_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.userdma.autotvout_outStreamTop_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.userdma.autotvout_outStreamTop_V_last_V.dat with impl_rtl.userdma.autotvout_outStreamTop_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_IN_inStreamTop_V_data_V "./stream_size_in_inStreamTop_V_data_V.dat"
