...
set Spec2ImplPortList { 
	...
	s2m_sts_clear_c { ap_fifo {  { s2m_sts_clear_c_din fifo_data 1 1 }  { s2m_sts_clear_c_full_n fifo_status 0 1 }  { s2m_sts_clear_c_write fifo_update 1 1 } } }
	s2mbuf { ap_none {  { s2mbuf in_data 0 64 } } }
	s2mbuf_c { ap_fifo {  { s2mbuf_c_din fifo_data 1 64 }  { s2mbuf_c_full_n fifo_status 0 1 }  { s2mbuf_c_write fifo_update 1 1 } } }
	m2s_sts_clear { ap_none {  { m2s_sts_clear in_data 0 1 } } }
	m2s_sts_clear_c { ap_fifo {  { m2s_sts_clear_c_din fifo_data 1 1 }  { m2s_sts_clear_c_full_n fifo_status 0 1 }  { m2s_sts_clear_c_write fifo_update 1 1 } } }
}
