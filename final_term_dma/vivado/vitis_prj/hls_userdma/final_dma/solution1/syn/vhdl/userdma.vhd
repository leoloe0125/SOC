...
architecture behav of userdma is 
    ...
    "userdma_userdma,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=4256,HLS_SYN_LUT=7759,HLS_VERSION=2022_1}";
    ...
    signal getinstream_U0_inbuf_din : STD_LOGIC_VECTOR (24 downto 0);
    ...
    signal paralleltostreamwithburst_U0_outbuf_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sendoutstream_U0_outStreamTop_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal sendoutstream_U0_outStreamTop_TVALID : STD_LOGIC;
    signal sendoutstream_U0_outStreamTop_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal sendoutstream_U0_outStreamTop_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal inbuf_dout : STD_LOGIC_VECTOR (24 downto 0);
    ...
    signal outbuf_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component userdma_fifo_w25_d1024_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component userdma_fifo_w32_d1024_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    inbuf_U : component userdma_fifo_w25_d1024_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    outbuf_U : component userdma_fifo_w32_d1024_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
