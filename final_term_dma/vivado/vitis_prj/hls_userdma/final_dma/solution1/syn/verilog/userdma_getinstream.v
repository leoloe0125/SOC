...
reg   [32:0] sub_i_i52_reg_279;
reg   [31:0] in_len_V_load_reg_284;
wire   [0:0] icmp_ln1065_fu_194_p2;
reg   [0:0] icmp_ln1065_reg_289;
...
wire   [24:0] grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_inbuf_din;
...
wire   [2:0] inStreamTop_TKEEP_int_regslice;
...
wire   [2:0] inStreamTop_TSTRB_int_regslice;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_119)) begin
        if ((in_en_clrsts_read_read_fu_102_p2 == 1'd1)) begin
            in_len_V <= 32'd0;
        end else if ((in_en_clrsts_read_read_fu_102_p2 == 1'd0)) begin
...
assign and_ln1065_fu_232_p2 = (xor_ln1069_fu_226_p2 & grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_icmp_ln1065_out);
...
always @ (*) begin
    ap_condition_119 = (~((ap_start == 1'b0) | (s2m_enb_clrsts_c_full_n == 1'b0) | (s2m_len_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1));
end
...
assign icmp_ln1065_fu_194_p2 = ((umax_fu_186_p3 == 32'd1) ? 1'b1 : 1'b0);
...
assign or_ln61_fu_251_p2 = (xor_ln58_fu_246_p2 | and_ln1065_fu_232_p2);
...
assign tmp_3_fu_238_p3 = grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_tmp_user_V_out[32'd2];

assign tmp_fu_218_p3 = grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_tmp_user_V_out[32'd3];

assign umax_fu_186_p3 = ((empty_fu_180_p2[0:0] == 1'b1) ? in_s2m_len : add_ln48_fu_174_p2);

assign xor_ln1069_fu_226_p2 = (tmp_fu_218_p3 ^ 1'd1);

assign xor_ln58_fu_246_p2 = (tmp_3_fu_238_p3 ^ icmp_ln1065_reg_289);
