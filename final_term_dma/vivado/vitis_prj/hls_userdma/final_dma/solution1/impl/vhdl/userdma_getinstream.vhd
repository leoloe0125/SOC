...
port (
    ...
    inbuf_din : OUT STD_LOGIC_VECTOR (24 downto 0);
...
attribute shreg_extract : string;
    ...
    signal sub_i_i52_reg_279 : STD_LOGIC_VECTOR (32 downto 0);
    signal in_len_V_load_reg_284 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln1065_fu_194_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1065_reg_289 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_inbuf_din : STD_LOGIC_VECTOR (24 downto 0);
    ...
    signal or_ln61_fu_251_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal xor_ln1069_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_fu_238_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln1065_fu_232_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln58_fu_246_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_ST_fsm_state1_blk : STD_LOGIC;
    signal ap_ST_fsm_state2_blk : STD_LOGIC;
    signal ap_ST_fsm_state3_blk : STD_LOGIC;
    signal regslice_both_inStreamTop_V_data_V_U_apdone_blk : STD_LOGIC;
    signal inStreamTop_TDATA_int_regslice : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal inStreamTop_TKEEP_int_regslice : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal inStreamTop_TSTRB_int_regslice : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    port map (
        ...
        in_len_V_load => in_len_V_load_reg_284,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((in_en_clrsts_read_read_fu_102_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                    s2m_err_preg <= or_ln61_fu_251_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_119)) then
                if ((in_en_clrsts_read_read_fu_102_p2 = ap_const_lv1_1)) then 
                    in_len_V <= ap_const_lv32_0;
                elsif ((in_en_clrsts_read_read_fu_102_p2 = ap_const_lv1_0)) then 
                    in_len_V <= umax_fu_186_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((in_en_clrsts_read_read_fu_102_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                icmp_ln1065_reg_289 <= icmp_ln1065_fu_194_p2;
                in_len_V_load_reg_284 <= in_len_V;
                sub_i_i52_reg_279 <= sub_i_i52_fu_162_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, s2m_len_c_full_n, s2m_enb_clrsts_c_full_n, in_en_clrsts_read_read_fu_102_p2, grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    and_ln1065_fu_232_p2 <= (xor_ln1069_fu_226_p2 and grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_icmp_ln1065_out);
    ...
    ap_condition_119_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, s2m_len_c_full_n, s2m_enb_clrsts_c_full_n)
    begin
                ap_condition_119 <= (not(((ap_start = ap_const_logic_0) or (s2m_enb_clrsts_c_full_n = ap_const_logic_0) or (s2m_len_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1));
    end process;
    ...
    icmp_ln1065_fu_194_p2 <= "1" when (umax_fu_186_p3 = ap_const_lv32_1) else "0";
    inStreamTop_TREADY <= regslice_both_inStreamTop_V_data_V_U_ack_in;

    inStreamTop_TREADY_int_regslice_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_inStreamTop_TREADY, ap_CS_fsm_state2)
    begin
    ...
    inbuf_write_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_inbuf_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            inbuf_write <= grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_inbuf_write;
        else 
    ...
    incount47_write_assign_proc : process(grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_incount47_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            incount47_write <= grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_incount47_write;
        else 
    ...
    or_ln61_fu_251_p2 <= (xor_ln58_fu_246_p2 or and_ln1065_fu_232_p2);
    ...
    s2m_err_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, s2m_len_c_full_n, s2m_enb_clrsts_c_full_n, in_en_clrsts_read_read_fu_102_p2, ap_CS_fsm_state3, s2m_err_preg, or_ln61_fu_251_p2)
    begin
        if (((in_en_clrsts_read_read_fu_102_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            s2m_err <= or_ln61_fu_251_p2;
        elsif ((not(((ap_start = ap_const_logic_0) or (s2m_enb_clrsts_c_full_n = ap_const_logic_0) or (s2m_len_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (in_en_clrsts_read_read_fu_102_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_3_fu_238_p3 <= grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_tmp_user_V_out(2 downto 2);
    tmp_fu_218_p3 <= grp_getinstream_Pipeline_VITIS_LOOP_48_1_fu_132_tmp_user_V_out(3 downto 3);
    umax_fu_186_p3 <= 
        in_s2m_len when (empty_fu_180_p2(0) = '1') else 
        add_ln48_fu_174_p2;
    xor_ln1069_fu_226_p2 <= (tmp_fu_218_p3 xor ap_const_lv1_1);
    xor_ln58_fu_246_p2 <= (tmp_3_fu_238_p3 xor icmp_ln1065_reg_289);
end behav;
