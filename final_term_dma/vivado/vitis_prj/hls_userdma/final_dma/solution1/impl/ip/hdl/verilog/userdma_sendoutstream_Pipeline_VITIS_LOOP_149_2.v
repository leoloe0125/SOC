...
always @ (posedge ap_clk) begin
    if (((icmp_ln149_reg_197 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_phi_reg_116 <= outbuf_dout[32'd31];
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign outStreamTop_TDATA = outbuf_dout[23:0];

assign outStreamTop_TKEEP = 3'd0;

assign outStreamTop_TLAST = outbuf_dout[32'd31];

assign outStreamTop_TSTRB = 3'd0;

assign outStreamTop_TUSER = {{outbuf_dout[30:24]}};
