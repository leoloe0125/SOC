set SynModuleInfo {
  ...
  {SRCNAME userdma MODELNAME userdma RTLNAME userdma IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME userdma_fifo_w25_d1024_A RTLNAME userdma_fifo_w25_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME userdma_fifo_w32_d64_A RTLNAME userdma_fifo_w32_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      ...
      {MODELNAME userdma_fifo_w32_d1024_A RTLNAME userdma_fifo_w32_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
