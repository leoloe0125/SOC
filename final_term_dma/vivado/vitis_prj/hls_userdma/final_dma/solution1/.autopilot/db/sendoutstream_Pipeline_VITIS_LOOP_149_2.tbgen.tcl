...
set portList { 
	...
	{ outbuf_dout sc_in sc_lv 32 signal 2 } 
	{ outbuf_num_data_valid sc_in sc_lv 11 signal 2 } 
	{ outbuf_fifo_cap sc_in sc_lv 11 signal 2 } 
	{ outbuf_empty_n sc_in sc_logic 1 signal 2 } 
	{ outbuf_read sc_out sc_logic 1 signal 2 } 
	{ outStreamTop_TDATA sc_out sc_lv 24 signal 3 } 
	{ outStreamTop_TVALID sc_out sc_logic 1 outvld 7 } 
	{ outStreamTop_TREADY sc_in sc_logic 1 outacc 3 } 
	{ outStreamTop_TKEEP sc_out sc_lv 3 signal 4 } 
	{ outStreamTop_TSTRB sc_out sc_lv 3 signal 5 } 
...
set Spec2ImplPortList { 
	...
	outStreamTop_V_data_V { axis {  { outStreamTop_TDATA out_data 1 24 }  { outStreamTop_TREADY out_acc 0 1 } } }
