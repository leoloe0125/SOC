...
set C_modelArgList {
	...
	{ inbuf int 25 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inStreamTop_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "inbuf", "interface" : "fifo", "bitwidth" : 25, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ inStreamTop_TDATA sc_in sc_lv 24 signal 0 } 
	{ inStreamTop_TVALID sc_in sc_logic 1 invld 4 } 
	{ inStreamTop_TREADY sc_out sc_logic 1 inacc 4 } 
	{ inStreamTop_TKEEP sc_in sc_lv 3 signal 1 } 
	{ inStreamTop_TSTRB sc_in sc_lv 3 signal 2 } 
	...
	{ inbuf_din sc_out sc_lv 25 signal 9 } 
	...
	{ incount47_num_data_valid sc_in sc_lv 7 signal 10 } 
	{ incount47_fifo_cap sc_in sc_lv 7 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inbuf_din", "direction": "out", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "inbuf", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	inbuf { ap_fifo {  { inbuf_din fifo_port_we 1 25 }  { inbuf_num_data_valid fifo_status_num_data_valid 0 11 }  { inbuf_fifo_cap fifo_update 0 11 }  { inbuf_full_n fifo_status 0 1 }  { inbuf_write fifo_data 1 1 } } }
