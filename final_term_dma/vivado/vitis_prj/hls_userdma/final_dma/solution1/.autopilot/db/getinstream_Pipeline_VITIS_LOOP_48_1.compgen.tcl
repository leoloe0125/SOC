...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TVALID { I 1 bit } inStreamTop_TDATA { I 24 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_inbuf \
    op interface \
    ports { inbuf_din { O 25 vector } inbuf_num_data_valid { I 11 vector } inbuf_fifo_cap { I 11 vector } inbuf_full_n { I 1 bit } inbuf_write { O 1 bit } } \
} "
}
