...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TDATA { O 24 vector } outStreamTop_TREADY { I 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_val_last_V \
    op interface \
    ports { out_val_last_V { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_outbuf \
    op interface \
    ports { outbuf_dout { I 32 vector } outbuf_num_data_valid { I 11 vector } outbuf_fifo_cap { I 11 vector } outbuf_empty_n { I 1 bit } outbuf_read { O 1 bit } } \
} "
}
