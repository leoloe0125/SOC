...
# FIFO definition: 
set ID 93
set FifoName userdma_fifo_w25_d1024_A
...
# FIFO definition: 
set ID 97
set FifoName userdma_fifo_w32_d1024_A
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TDATA { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TKEEP { I 3 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStreamTop_TSTRB { I 3 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TDATA { O 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TKEEP { O 3 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { outStreamTop_TSTRB { O 3 vector } } \
} "
} else {
