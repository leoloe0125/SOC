...
//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.userdma.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.userdma.autotvout_gmem0.dat"
 ...
 parameter   FIFO_DEPTH            =   10 + 10;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter gmem0_C_DATA_BITWIDTH = 32'd 32;
parameter gmem0_mem_depth = 32'd 64;
parameter ReadReqLatency = 32'd 10;
parameter WriteReqLatency = 32'd 10;
// Input and Output
input clk;
input reset;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/ubuntu/Desktop/caravel-soc_fpga-lab/fsic_fpga/fsic_fpga/vivado/vitis_prj/hls_userdma/userdma/solution1/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/ubuntu/Desktop/caravel-soc_fpga-lab/fsic_fpga/fsic_fpga/vivado/vitis_prj/hls_userdma/userdma/solution1/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
      ...
      if (factor == 2) begin
          if ((gmem0_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  ...
                  3 : tmp_data = gmem0_mem_3[gmem0_mem_depth/factor][15:0];
                  default: $display("The page_num of write file is not valid!");
              endcase
              bin_data = tmp_data;
              write_binary(fp,bin_data,16);
